...
mypy:
	python3 -m mypy --check-untyped-defs --exclude=src/moment_cone/reference_datas src/moment_cone tests

mypy_strict:
	python3 -m mypy --strict --no-warn-unused-ignores src/moment_cone tests
