...
def compare_to_reference(list_ineq: Sequence[Inequality], V: Representation, source: str = "user", source_ref: Optional[str] = None) -> Comparison[Inequality]:
    """
    ...
    source_ref, reference = get_reference_ineqs(V, source_ref)
